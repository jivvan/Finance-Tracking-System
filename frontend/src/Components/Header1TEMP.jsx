  ...
  return (
    <header>
      <Navbar
        fluid={true}
        rounded={true}
        className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 shadow"
      >
        ...
        <div className="flex items-center lg:order-2">
          <Link
            to=""
            className="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
          >
            Logout
          </Link>
          <Button
