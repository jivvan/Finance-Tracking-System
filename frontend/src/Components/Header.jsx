      ...
      >
        ...
        <div className="flex items-center lg:order-2">
            ...
            <>
              <Link
                to="/login"
                className="text-black border border-gray-300 hover:bg-gray-300 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
              >
                Log in
              </Link>
              <Link
