...
function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const response = await axios.post('https://finance-tracking-system.onrender.com/auth/register', {
        email,
        username,
        password,
      });
    ...
    <section className="bg-gray-50 dark:bg-gray-900 py-14">
      <div className="container mx-auto flex items-center justify-between">
        <div className="w-1/2 mb-32 ml-28 ">
          <h1 className='text-left text-4xl font-bold text-blue-600'>Join Today!</h1> 
